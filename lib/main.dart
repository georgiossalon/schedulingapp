    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<DesignationsBloc>(create: (context) {
          return DesignationsBloc(
              employeesRepository: FirebaseEmployeesRepository())
            ..add(LoadDesignations());
        }),
        BlocProvider<DateEventsBloc>(
          create: (context) {
            return DateEventsBloc(
              // context.bloc<DesignationsBloc>(), // consume the same instance
              dateEventsRepository: FirebaseDateEventsRepository(),
            );
        ...
        BlocProvider<ShiftsBloc>(
          create: (context) {
            return ShiftsBloc(
              designationsBloc: context.bloc<DesignationsBloc>(),
              dateEventsRepository: FirebaseDateEventsRepository(),
              employeeRepository: FirebaseEmployeesRepository(),
            );
          },
        )
      ],
        ...
        routes: {
          ...
          AddEditEmployee.screenId: (context) {
            return AddEditEmployee(
              onSave: (designation, employeeName, weeklyHours, salary, email,
                  hiringDate, busyMap) {
